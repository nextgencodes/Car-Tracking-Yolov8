...
def vehicle_count(source_path, destination_path, line_start, line_end):
   ...
   for result in model.track(source = source_path, tracker = 'bytetrack.yaml', show=True, stream=True, agnostic_nms=True, iou=0.4, conf=0.3):
...
if __name__ == "__main__":
    ...
    vehicle_count(source_path = "http://31.173.125.161:82/mjpg/video.mjpg",
              destination_path = "Data/Example Results",
              line_start = (0, 340),
              line_end = (1200, 340))